              ...
              return (
                <div key={idx}>
                  <ul className="flex flex-col gap-3">
                    <h5 className="mb-2 font-medium text-default-800 dark:text-default-800 lg:text-lg xl:text-xl">
                      {item.title}
                    </h5>
                          ...
                          {Icon ? (
                            <li className="group flex items-center gap-5">
                              <Link
                                ...
                                className="inline-flex h-10 w-10 items-center justify-center rounded-lg border border-default-300 dark:border-default-400 text-default-800 dark:text-default-800 transition-all duration-700 group-hover:border-primary group-hover:bg-primary group-hover:text-white dark:group-hover:border-primary dark:group-hover:bg-primary dark:group-hover:text-white  dark:bg-default-300"
                              >
                                <Icon className="h-5 w-5" />
                              </Link>
                              <h5 className="text-base font-medium text-default-800 dark:text-default-800">
                                {item.name}
                              </h5>
                            </li>
                          ) : (
                            <li>
                              <Link
                                href={`${item.link ? item.link : ''}`}
                                className="text-base text-default-700 dark:text-default-800transition-all hover:text-default-950 dark:hover:text-default-900"
                              >
                                {item.name}
                              </Link>
                            </li>
