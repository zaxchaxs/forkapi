...
const FAQs = () => {
  return (
    <section id="faq" className="py-5 lg:py-10 dark:bg-default-200">
          ...
          <div className="hs-accordion-group space-y-4">
            {faqContent.map((item, idx) => {
              return (
                <div
                  key={idx}
                  className="hs-accordion active overflow-hidden rounded-lg border border-default-200 bg-white dark:bg-default-100 dark:border-default-400 transition-all duration-500 hover:border-default-300 dark:hover:border-default-600"
                  id={`faq-${idx}`}
                >
                  <button
                  ...
                  >
                    <div className="px-6 pb-4 pt-0">
                      <p className="text-sm sm:text-base text-default-600 dark:text-default-700">
                        {item.description}
                      </p>
                    </div>
                  </div>
