        ...
        <div className="grid items-center gap-6 lg:grid-cols-2">
          <div>
            ...
            <h2 className="mt-4 text-4xl/snug font-medium text-default-950">
              Forum Komunikasi Pembangunan Indonesia
            </h2>
            <p className="mt-5 text-base">
              Lorem, ipsum dolor sit amet consectetur adipisicing elit. Debitis ratione aspernatur aliquid eaque quod natus illum tempora, labore corporis odio omnis rerum. Quidem assumenda quas dolorum ad quo eaque dolores!s.
            </p>
            <div className="mt-10">
              <Link
                href=""
